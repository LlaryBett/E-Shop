      ...
      <div className="container mx-auto px-3 sm:px-4 py-4">
        ...
        <section className="py-4 sm:py-6 md:py-8 mt-12 sm:mt-16">
          ...
          <div className="text-center mt-6 sm:mt-8">
            <Link
              to="/shop"
              className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-4 py-2.5 sm:px-6 sm:py-3 font-medium transition-colors w-full max-w-xs mx-auto text-sm sm:text-base"
            >
              View All Products
            </Link>
          </div>
